<?php 
    ...
    try{
        ...
        $mensajeCompleto = 
        "Recibiste una consulta desde propiedadescyp<br>
        <br>
        <b><u>Agente:</u> </b>".$nameAgent."<br/>
        <b><u>Asunto:</u> </b>Recibiste una consulta desde propiedadescyp.cl<br/>
        ...
        <a href='http://propiedadescyp.cl/'>www.propiedadescyp.cl.cl</a>
        ";
        
        $mail->isSMTP();                     
        $mail->Host = 'c2120007.ferozo.com';  
        $mail->SMTPAuth = true;                
        $mail->Username = 'contacto@propiedadescyp.cl';
        $mail->Password = 'Propiedades2021';                
        $mail->SMTPSecure = 'ssl';                            
        $mail->Port = 465;          
        
        $mail->SetFrom( $email , 'Un cliente quiere contactar con propiedadescyp.cl' );
        $mail->addAddress( "contacto@propiedadescyp.cl", 'Mensaje desde la web');   
        $mail->isHTML(true);                                 
