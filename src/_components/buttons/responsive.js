...
export default ({ onClick, visible })=> {
  ...
  useEffect(()=> {
    if(visible){
      ...
      gsap.to('#responsive-bar-middle', .25, { opacity: 0, backgroundColor: "#fff" });
      gsap.to('#responsive-bar-bottom', .25, { y: -7, rotate: -45, backgroundColor: "#fff"  });
    } else{
      gsap.to('#responsive-bar-top', .25, { y: 0, rotate: 0, backgroundColor: "#1c8742" });
      gsap.to('#responsive-bar-middle', .25, { opacity: 1, backgroundColor: "#1c8742" });
      gsap.to('#responsive-bar-bottom', .25, { y: 0, rotate: 0, backgroundColor: "#1c8742"  });
    }
  },[visible, "#fff"])
